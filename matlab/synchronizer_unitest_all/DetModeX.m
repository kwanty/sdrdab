...
function [ Mode, NSampPerFrame, NSampPerNull, NSymbPerFrame, NSampPerSymb, NSampPerGuard, Nfft, NCarrPerSymb, FreqIntTabSize, Offset, NCIFsPerFrame, NSymbPerFIC ] = DetModeX( Signal, FrameStartpoints, SuffixFileName )
...
fp = fopen( sprintf('../../data/ut/synchronizer_mode_output%s.txt', SuffixFileName), 'w' );
fprintf( fp, '%1.18f\n', Mode );
fclose( fp );
                                   % For Mode=1
