...
if(1) ReadFile = fopen('Record3_katowice_iq.dat', 'rb'); fs_file = 2.048e6;  sigtype=1;  fi=0;  coef = 0; end
...
% ##########################
      ...
      % DAB+ Kraków - TZ without AGC correct BAD BAD BAD
...
if(0) ReadFile = 'DAB_Krakow_20150102_IQ_3secs.wav';            fs_file = 2.048e6;  sigtype=3;   fi=0;  coef=0.9; end
      % DAB+ KRAKÓW - TZ Kraków with AGC correct OK OK OK OK
