          ...
          % Super Frame Handling --------------------------------------------------------------------
            ...
            if(SuperFrame2AAC==1) % Super Frame decoding - below
               ...
               % CIFCount, 1+NBitsPerFrame*CIFCount, NDE+NBitsPerFrame*CIFCount, pause
                 ...
                 fid2 = fopen('../../data/ut/super_frame_in_m2.txt', 'a');
               ...
               % Additional delay of 5 CIFs = one DAB+ Super Frame. Together we have delay of 16+5 = 21 CIFs
                 [ CIFCount, SuperFrameSync, DataEnergChain, au_start, num_aus ] = SuperFrameHandlingXm2( CIFCount, SuperFrameSync, DataEnergChain, au_start, Audiokbps, lan, num_aus, NBitsPerCIF, NCIFsPerFrame, RSpolynomial, fid);
                 if (DABFrameNr == 37)
                     return;
                 end
