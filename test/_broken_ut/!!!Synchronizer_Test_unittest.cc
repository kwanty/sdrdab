...
class SynchronizerTest  : public ::testing::Test{
    protected:
        SynchronizerTest(){
            ...
            mode_input_len = 500000;
            mode_input = new float[mode_input_len*2];
            mode_output = new float[1];

            syn_mode_unknown = new Synchronizer(500000);
        ...
        virtual void SetUp(){
            dataLoaded1 = MatlabIO::ReadData( data1, "./data/ut/synchronizer_null_input_1.txt", length_in*2 );
            resultLoaded1 = MatlabIO::ReadData( expectedResults1, "./data/ut/synchronizer_null_output_1.txt", length_out );

            dataLoaded2 = MatlabIO::ReadData( data2, "./data/ut/synchronizer_null_input_2.txt", length_in*2 );
            resultLoaded2 = MatlabIO::ReadData( expectedResults2, "./data/ut/synchronizer_null_output_2.txt", length_out );

            dataLoaded3 = MatlabIO::ReadData( data3, "./data/ut/synchronizer_null_input_3.txt", length_in*2 );
            resultLoaded3 = MatlabIO::ReadData( expectedResults3, "./data/ut/synchronizer_null_output_3.txt", length_out );

            mode_input_loaded = MatlabIO::ReadData( mode_input, "./data/ut/synchronizer_mode_input.txt", mode_input_len*2 );
            mode_output_loaded = MatlabIO::ReadData( mode_output, "./data/ut/synchronizer_mode_output.txt", 1 );
        }
...
TEST_F(SynchronizerTest, mode_detect) {
...
TEST_F(SynchronizerTest, null_detect_frame_1) {
...
TEST_F(SynchronizerTest, null_detect_frame_2) {
...
TEST_F(SynchronizerTest, null_detect_frame_3) {
...
TEST_F(SynchronizerTest, process_frame_1) {
    ASSERT_TRUE(dataLoaded1) << "TESTING CODE FAILED... could not load input data";
    ASSERT_TRUE(resultLoaded1)  << "TESTING CODE FAILED... could not load expected result";
...
TEST_F(SynchronizerTest, process_frame_2) {
    ASSERT_TRUE(dataLoaded2) << "TESTING CODE FAILED... could not load input data";
    ASSERT_TRUE(resultLoaded2)  << "TESTING CODE FAILED... could not load expected result";
...
TEST_F(SynchronizerTest, process_frame_3) {
    ASSERT_TRUE(dataLoaded3) << "TESTING CODE FAILED... could not load input data";
    ASSERT_TRUE(resultLoaded3)  << "TESTING CODE FAILED... could not load expected result";
