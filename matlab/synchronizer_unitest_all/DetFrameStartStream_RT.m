...
%@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
  ...
  %%%%%%%%%%%%% generate input data %%%%%%%%%%%%%%%%%%%%%
  if (DABFrameFoundNr > 0)
    fp = fopen( sprintf('../../data/ut/synchronizer_null_input_%d%s.txt', DABFrameFoundNr, SuffixFileName), 'w' );
    NumOfSamples = 400000;
  ...
  if( DABFrameFoundNr == 0 )   
      % NSampPerSynchro = NSampPerFrame + NSampPerNull;
      NSampPerSynchro = NSampPerFrame;
  else
      NSampPerSynchro = 2*NSampPerNull;
  end
  ...
  if (DABFrameFoundNr > 0)
    fp = fopen( sprintf('../../data/ut/synchronizer_null_output_%d%s.txt', DABFrameFoundNr, SuffixFileName), 'w' );
    fprintf( fp, '%1.18f\n', imin-1 );
    fprintf( fp, '%1.18f\n', df_fractnew );
    fprintf( fp, '%1.18f\n', df_intnew );
    fclose( fp );
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    fprintf('\nnull_pos = %d, fc_drift = %d\n\n', imin-1, df_fractnew+df_intnew);
