 ...
 * @author Miroslaw Szewczyk mirsze@student.agh.edu.pl (Synchronizer::calculateSNRfromPREFIX, Synchronizer::DecodeNull); new 100%
...
void Synchronizer::DetectPhaseReference(const float* data, size_t size, void * datafeeder)
{
	...
	if(fc_drift_*fc_drift_ < 0.05 && !fc_short_search_) {
...
void Synchronizer::setVerbose_(bool verbose) {
    Synchronizer::verbose_ = verbose;
}
