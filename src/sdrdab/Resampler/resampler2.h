...
#ifndef RESAMPLER2_H_
#define RESAMPLER2_H_
...
public:
    ...
    */
    Resampler2(resampling_type type, size_t inner_buffer_size);
    virtual ~Resampler2();

    /**
    * Main Resampler2 method, takes data from source buffer of specified length and ratio, then resamples it into inner buffer.
...
private:
    ...
    */
    int conv_type_;
    /**
    * Inner data buffer, should be at least 3 times longer than maximum Resampler2 input to assure stability
    */
    float *data_buffer_;
    /**
    ...
    */
    int debug;
    /**
    * Used store Q sample value that will be useful in the next iteration of Resampler2 processing
    */
    float previous_sample_Q_;
    /**
    * Used store I sample value that will be useful in the next iteration of Resampler2 processing
    */
    float previous_sample_I_;
    /**
    * Array to store sample positions that will be useful in the next iteration of Resampler2 processing
    */
    ...
    */
    size_t length_;
    /**
    * Indicates that this is first iteration of resampler2 after object creation
    */
