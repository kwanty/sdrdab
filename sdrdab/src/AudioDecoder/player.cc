...
void Player::SetTagsFilters() {
	...
	tags_map_parsers_->insert(std::make_pair(GST_TAG_TITLE, PlayerCallbacks::ParseStringTag));
	tags_map_parsers_->insert(std::make_pair(GST_TAG_ARTIST, PlayerCallbacks::ParseStringTag));
	tags_map_parsers_->insert(std::make_pair(GST_TAG_ALBUM, PlayerCallbacks::ParseStringTag));
	tags_map_parsers_->insert(std::make_pair(GST_TAG_GENRE, PlayerCallbacks::ParseStringTag));
	tags_map_parsers_->insert(std::make_pair(GST_TAG_DATE_TIME, PlayerCallbacks::ParseDateTag));
}
