...
sudo sh -c "apt-get update; apt-get install -y \
    cmake \
    doxygen \
    rtl-sdr gqrx-sdr libgtest-dev libfftw3-dev libfftw3-bin libsndfile1 libsndfile1-dev libsamplerate0-dev libusb-1.0-0-dev librtlsdr-dev librtlsdr0 \
