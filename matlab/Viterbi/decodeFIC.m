...
if(idx ==15 )
    writeReal( DataDep(1,:), sprintf('../../data/ut/vitterbi_in_FIC_%d_%d.txt', idx, 0), length(DataDep(1,:)) );
    writeReal( DataDep(2,:), sprintf('../../data/ut/vitterbi_in_FIC_%d_%d.txt', idx, 1), length(DataDep(1,:)) );
    writeReal( DataDep(3,:), sprintf('../../data/ut/vitterbi_in_FIC_%d_%d.txt', idx, 2), length(DataDep(1,:)) );
    writeReal( DataDep(4,:), sprintf('../../data/ut/vitterbi_in_FIC_%d_%d.txt', idx, 3), length(DataDep(1,:)) );
end
...
if(idx ==15 )
    writeReal( DataVit(1,:), sprintf('../../data/ut/vitterbi_out_FIC_%d_%d.txt', idx, 0), 768 );
    writeReal( DataVit(2,:), sprintf('../../data/ut/vitterbi_out_FIC_%d_%d.txt', idx, 1), 768 );
    writeReal( DataVit(3,:), sprintf('../../data/ut/vitterbi_out_FIC_%d_%d.txt', idx, 2), 768 );
    writeReal( DataVit(4,:), sprintf('../../data/ut/vitterbi_out_FIC_%d_%d.txt', idx, 3), 768 );
end
