...
function decodeMSCm3( DABFrameNr, DataMSC, SubChStartAdr, SubChSize, Audiokbps, Protection, UEP, trellis, RSpolynomial, SuperFrame2AAC, NBitsAfterTimeDepunct, DebugOn )
...
global CIFCount SuperFrameSync DataEnergChain au_start num_aus lan fid
   ...
   % Extracting data of one sub-channel requested by the user (CU=64bits = the smallest addressable unit)----
     ...
     fid2 = fopen(['../../data/ut/blocks3.txt'], 'at');
    ...
    if (DABFrameNr == 31)
            ...
            blocks = importdata('../../data/ut/blocks3.txt');
            ...
            for k = 1 : 15
                ...
                if(k == 1)
                    fp = fopen('../../data/ut/mscdec_in_m3.txt','a');
                    ...
                    fp = fopen('../../data/ut/mscdec_in_m3.txt','a');
                    for i=length(DataToInputFile_mode_2)-7679:length(DataToInputFile_mode_2)
                        fprintf( fp, '%f\n', DataToInputFile_mode_2(i) );
                    end
                    fclose( fp );
                end
          ...
          % Super Frame Handling --------------------------------------------------------------------
            ...
            if(SuperFrame2AAC==1) % Super Frame decoding - below
               ...
               % CIFCount, 1+NBitsPerFrame*CIFCount, NDE+NBitsPerFrame*CIFCount, pause
                 ...
                 fid2 = fopen('../../data/ut/mscdec_out_m3.txt', 'a');
