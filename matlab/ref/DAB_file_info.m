  ...
  if(TestMode==1)
    ...
    % ------------------------------------------------------------------------------------------
      ...
      if(Mode==1) % London Mode=1, only DAB
        ...
        % SubChStartAdr = 192; Protection = 3;   SubChSize = 96; Audiokbps =  128; UEP = true; % ok
        % SubChStartAdr = 288; Protection = 3;   SubChSize = 96; Audiokbps =  128; UEP = true; % ok
        % SubChStartAdr = 384; Protection = 3;   SubChSize = 58; Audiokbps =   80; UEP = true; % ok
        % SubChStartAdr = 442; Protection = '3-A'; SubChSize = 12;
        % SubChStartAdr = 454; Protection = 3;   SubChSize = 58; Audiokbps =   80; UEP = true; % ok
        % SubChStartAdr = 512; Protection = 3;   SubChSize = 58; Audiokbps =   80; UEP = true; % ok
        % SubChStartAdr = 570; Protection = 3;   SubChSize = 35; Audiokbps =   48; UEP = true; % ok
        % SubChStartAdr = 605; Protection = 3;   SubChSize = 96; Audiokbps =  128; UEP = true; % silence, correct parms
        % SubChStartAdr = 701; Protection = 3;   SubChSize = 96; Audiokbps =  128; UEP = true; % ok
...
if(0) SubChStartAdr = 728; SubChSize = 60;  Audiokbps = 0;    Protection = ['3A']; UEP=false; end % Channel #10 DAB+ Ok �wisty
...
% ##########################
      ...
      % DAB+ Krak�w - TZ without AGC correct BAD BAD BAD
...
if(0) ReadFile = 'DAB_Krakow_20150102_IQ_3secs.wav';            fs_file = 2.048e6;  sigtype=3;   fi=0;  coef=0.9; end
      % DAB+ KRAK�W - TZ Krak�w with AGC correct OK OK OK OK
...
% SubChID:  8   StartAdr: 516   EEP   ProtLevel: 3-A   SubChSize:  78   % Radio Krak�w
